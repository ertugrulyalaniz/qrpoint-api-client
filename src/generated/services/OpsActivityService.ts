...
export class OpsActivityService {
     ...
     * @throws ApiError
     */
    public static postApiOpsActivityCreate(
        xClientId: string,
        xTenantId: string,
        requestBody: ApiCommandRequestOfCreateActivityOpsData,
        acceptLanguage?: string,
    ): CancelablePromise<ApiResponseOfCreateActivityOpsResult> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/ops/activity/create',
            headers: {
