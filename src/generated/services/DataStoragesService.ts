...
export class DataStoragesService {
     ...
     * @throws ApiError
     */
    public static postApiDataStoragesGetbyid(
        xClientId: string,
        requestBody: ApiQueryRequestOfIdData,
        acceptLanguage?: string,
    ): CancelablePromise<ApiResponseOfStorageDto> {
     ...
     * @throws ApiError
     */
    public static postApiDataStoragesGetall(
        xClientId: string,
     ...
     * @throws ApiError
     */
    public static postApiDataStoragesGetpaged(
        xClientId: string,
        requestBody: ApiQueryRequestOfEmptyDataAndPagingDataAndEmptyFiltersAndEmptySortAndEmptyOptions,
        acceptLanguage?: string,
    ): CancelablePromise<ApiResponseOfStorageDto> {
