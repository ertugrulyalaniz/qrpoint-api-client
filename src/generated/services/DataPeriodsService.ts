...
import type { ApiCommandRequestOfListOfPeriodDtoAndBatchCommandOptions } from '../models/ApiCommandRequestOfListOfPeriodDtoAndBatchCommandOptions';
...
export class DataPeriodsService {
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsDeletedGetbyid(
        xClientId: string,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/data/periods/deleted/getbyid',
            headers: {
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsDeletedGetall(
        xClientId: string,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/data/periods/deleted/getall',
            headers: {
                'accept-language': acceptLanguage,
                'x-client-id': xClientId,
            },
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsDeletedGetpaged(
        xClientId: string,
        requestBody: ApiQueryRequestOfEmptyDataAndPagingDataAndListOfFilterItemAndListOfSortItemAndEmptyOptions,
        acceptLanguage?: string,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/data/periods/deleted/getpaged',
            headers: {
                'accept-language': acceptLanguage,
                'x-client-id': xClientId,
            },
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsDeletedRestore(
        xClientId: string,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/data/periods/deleted/restore',
            headers: {
                'accept-language': acceptLanguage,
                'x-client-id': xClientId,
            },
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsDeletedDelete(
        xClientId: string,
        requestBody: ApiCommandRequestOfIdDataAndEmptyOptions,
        acceptLanguage?: string,
    ): CancelablePromise<ApiResponseOfIdData> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/data/periods/deleted/delete',
            headers: {
                'accept-language': acceptLanguage,
                'x-client-id': xClientId,
            },
    ...
    public static postApiDataPeriodsBatch(
        xClientId: string,
        requestBody: ApiCommandRequestOfListOfPeriodDtoAndBatchCommandOptions,
        acceptLanguage?: string,
    ): CancelablePromise<ApiResponseOfIReadOnlyListOfPeriodDto> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsGetbyids(
        xClientId: string,
     ...
     * @throws ApiError
     */
    public static postApiDataPeriodsGetstatistics(
        xClientId: string,
        acceptLanguage?: string,
    ): CancelablePromise<ApiResponseOfEntityStatisticsDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/data/periods/getstatistics',
            headers: {
                'accept-language': acceptLanguage,
                'x-client-id': xClientId,
            },
